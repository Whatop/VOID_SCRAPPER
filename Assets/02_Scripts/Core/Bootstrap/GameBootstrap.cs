...
public class GameBootstrap : MonoBehaviour
{
    ...
    private void CacheReferences()
    {
        ...
        if (gameStateManager == null)
        {
            Debug.LogError("GameStateManager가 연결되지 않았습니다.", this);
        }

        if (sceneFlowManager == null)
        {
            Debug.LogError("SceneFlowManager가 연결되지 않았습니다.", this);
        }

        if (runManager == null)
        {
            Debug.LogError("RunManager가 연결되지 않았습니다.", this);
        }

        if (saveManager == null)
        {
            Debug.LogError("SaveManager가 연결되지 않았습니다.", this);
        }

        if (permanentProgress == null)
        {
            Debug.LogError("PermanentProgress가 연결되지 않았습니다.", this);
        }
    }
